...
window.__translations['ru'] = {
    ...
    "step1.setting.timecodes": "Главы (таймкоды)",
    ...
    "step2.gen.timecodes": "Главы (таймкоды)",
    ...
    "application.authorPhotos.label": "Фото авторов (необязательно)",
    "application.authorPhotos.description": "Один автор — одна папка на Google Drive с включённым доступом на просмотр.",
    "application.authorPhotos.exampleLink": "пример",
    "application.authorPhotos.warning": "Вставьте ссылку на фото авторов, чтобы создать обложки.",
    "application.authorPhotos.invalid": "Вставьте корректную ссылку на Google Drive.",
    "application.authorPhotos.add": "Добавить ссылку на фото автора",
    "application.authorPhotos.remove": "Удалить ссылку на фото автора",
    "application.authorPhotos.addFirst": "Вставьте корректную ссылку на фото автора, прежде чем добавлять следующего.",
    ...
    "application.outputs.timecodes.title": "Главы (таймкоды) для исходного видео",
    ...
    "application.outputs.autoEdit.timecodes": "Главы (таймкоды) для укороченного видео",
    "application.outputs.autoEdit.audiobook": "Сделать аудиокнигу из глав",
    "application.outputs.autoEdit.audiobook.description": "Получите папку с .mp3-файлами",
